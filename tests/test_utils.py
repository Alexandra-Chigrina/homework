...
@patch(
    "builtins.open", new_callable=mock_open, read_data='[{"id": 441945886, "currency": "RUB", "amount": "31957.58"}]'
)
...
@patch("builtins.open", new_callable=mock_open, read_data='{"id": 441945886, "currency": "RUB", "amount": "31957.58"}')
